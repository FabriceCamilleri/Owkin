...
def cindex(y_true_times, predicted_times, tol=1e-8):
    ...
    assert set(y_true_times.columns) == {'Event', 'SurvivalTime'}, 'C! Y true times should be pd dataframe with `PatientID` as index, and `Event` and `SurvivalTime` as columns'
